    ...
    <div class="p-1">
        ...
        <div class="p-5">
            ...
            <div class="row">
                <div class="col-6 offset-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre_huesped"  value="{{$huesped->nombre_huesped}}"class="form-control">
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <center><div class="row">
                    <div class="col-6 offset-3">
                        <!--<a href="{url('/huespedes/edit/',$huesped->id_huesped)}}" class="btn btn-info">Actualizar Huesped</a>!-->
